...
class Shell:
    ...
    def train(self, args):
        ...
        #text = open("movie.test",'r').read()
        #print(str(self.bigram.getPerplexity(text)))

    # Imports the data that has been previously stored
    ...
    # Exports the data in the current gram model.s
    ...
    # Prints out the available functions.
    def help(self, args):
        print("The follow are valid commands:\ntrain\nimport_data\nexport_data\ngenerate_random\nauthor_prediction\nhelp\nexit")
        print("For future clarification, please read the readme.txt file.")
    
    # Generates random strings based on the unigram and bigram models.
    def generate_random(self, args):
        self.unigram = Gram(1, None, 0)
        print("The random sentence generated by the unigram model is:")
        print(self.unigram.randomSentence())
        print("The random sentence generated by the bigram model is:")
        print(self.bigram.randomSentence())

    # Helper function for author_prediction
    ...
    # Runs the author prediction algorithm to determine authors for 
    # unknown text corpi. 
    def author_prediction(self, n, smoothingBound):
